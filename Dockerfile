...
RUN --mount=type=cache,target=/root/.cache/go-build \
    ...
    -run 'Test(Hardening|Optimization|Repair|Points|TaskIntent|VisualPlan|MediaQuality|Dialogue|Memory|NativePrepareSocial|SQLiteQueryCancellation|RuntimeClose|RuntimeFixture)' .
