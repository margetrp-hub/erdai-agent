...
func (a *AgentRuntime) installationStatus() installationStatus {
	checks := []installationCheck{
		...
		{ID: "ops", Label: "Sub2API 渠道监控", Configured: strings.TrimSpace(a.opsToken) != "" || a.configuredIntegration("ops_policy", "ERDAI_OPS_TOKEN"), Required: false, Source: "Core config / process environment", Detail: "/渠道 与 /雷达"},
	}
	configuredCount := 0
	requiredCount := 0
	ready := true
